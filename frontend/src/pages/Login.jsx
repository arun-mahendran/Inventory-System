    ...
    <div className="login-page">
      <div className="login-container">
        ...
        >
          ...
          <h1>Final Mile Delivery Hub</h1>

          <div className="route-line">
            <svg viewBox="0 0 500 28" preserveAspectRatio="none">
              <path className="route-path" d="M10 16 L490 16" />

              <path className="route-progress" d="M10 16 L490 16" />

              <circle cx="10" cy="16" r="4" fill="#ff5a1f" />

              <circle cx="490" cy="16" r="4" fill="#ff5a1f" />
            </svg>
        ...
        <div className="login-card" ref={cardRef} onMouseMove={handleCardMove}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="agent-cta">
              <p>Interested in becoming a Delivery Agent?</p>
